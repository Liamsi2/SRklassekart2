...
class StudentManager {
    ...
    addStudent() {
        ...
        const student = {
            ...
            constraints: [],
            preferences: {
                preferredPartners: [], // Students this person should sit near
                avoidPartners: [],     // Students this person should avoid
                sectionPreference: '', // 'left', 'middle', 'right', or ''
                sectionWeight: 1.0     // 1.0 = normal, 2.0 = strong preference
            }
        };
    ...
    setStudentPreferences(studentId, preferences) {
        const student = this.students.find(s => s.id === studentId);
        if (student) {
            student.preferences = { ...student.preferences, ...preferences };
            storageManager.updateStudent(student);
            this.loadStudents();
        }
    }
